...
const PaperCard: React.FC<PaperCardProps> = ({ 
                  ...
                  style={
                    mainImageError
                      ...
                      : {
                          ...
                          filter: 'blur(40px) opacity(0.3) saturate(1.5)',
                          transform: 'scale(1.2)' 
                        }
                  }
              />
        ...
        {hasTeaser && (
            <div className="relative w-full h-full shrink-0 snap-center overflow-hidden bg-white">
                 ...
                 <div 
                    ...
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    filter: 'blur(40px) opacity(0.2) saturate(1.3)',
                    transform: 'scale(1.2)' 
                    }}
                />
  ...
  <div className="absolute right-3 bottom-12 z-40 flex flex-col items-center gap-6 pointer-events-auto drop-shadow-lg">
        
        {/* Like */}
        <div className="flex flex-col items-center gap-1 group">
          <button 
            onClick={toggleLike}
            className={`p-3.5 rounded-full backdrop-blur-md shadow-lg transition-all active:scale-90 duration-300 group-hover:scale-110 ${liked ? 'bg-red-50 text-red-500 shadow-red-200/50' : 'bg-white/60 text-slate-700 hover:bg-white shadow-slate-300/50'}`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={liked ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
          </button>
          <span className="text-[10px] font-bold text-slate-500 drop-shadow-sm">{paper.total_likes}</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1 group">
          <button 
            ...
            className={`p-3.5 rounded-full backdrop-blur-md shadow-lg transition-all active:scale-90 duration-300 group-hover:scale-110 ${disliked ? 'bg-indigo-50 text-indigo-500 shadow-indigo-200/50' : 'bg-white/60 text-slate-700 hover:bg-white shadow-slate-300/50'}`}
          >
          ...
          <span className="text-[10px] font-bold text-slate-500 drop-shadow-sm">Dislike</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1 group">
          <button 
            ...
            className={`p-3.5 rounded-full backdrop-blur-md shadow-lg transition-all active:scale-90 duration-300 group-hover:scale-110 ${collections.length > 0 ? 'bg-emerald-50 text-emerald-600 shadow-emerald-200/50' : 'bg-white/60 text-slate-700 hover:bg-white shadow-slate-300/50'}`}
          >
          ...
          <span className="text-[10px] font-bold text-slate-500 drop-shadow-sm">Save</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1 group">
          <a 
            ...
            className="p-3.5 rounded-full bg-white/60 backdrop-blur-md text-slate-700 transition-all hover:bg-white active:scale-90 shadow-lg shadow-slate-300/50 group-hover:scale-110"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
          </a>
          <span className="text-[10px] font-bold text-slate-500 drop-shadow-sm">PDF</span>
        </div>
